...
- Used to classify, cluster, categorize, or otherwise group dcouments based on the attributes of that document
...
- A dataset of 20 categories with 18,000 posts on a newgroups website
...
- What are features?
  - They are measureable (meaning you can put a number to them)
...
- Fasle negative: instances that breast cancer was NOT indicated and it's breast cancer
