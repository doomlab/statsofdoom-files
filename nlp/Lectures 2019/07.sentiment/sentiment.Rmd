...
- How well did we do? Don't forget this function is in the separate provided `.py` file. 

```{python}
##python chunk
from sklearn.metrics import classification_report
classification_report(y_true=example_test_sentiments,
...
#model performance
classification_report(y_true=test_sentiments, 
